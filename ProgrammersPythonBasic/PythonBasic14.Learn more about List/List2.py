...
list1.insert(10000,333)
# list의 index를 벗어난 값을 입력해도 괜찮다 대신 맨 마지막에 입력되게 된다
print(list1) #[135, 462, 999, 27, 2753, 234, 9, 10, 9999, 11, 333] 출력

list1.sort()
# list 내부의 값이 순서대로 정렬된다
print(list1) #[9, 10, 11, 27, 135, 234, 333, 462, 999, 2753, 9999] 출력

list1.reverse()
# 값을 역순으로 정렬
print(list1) #[9999, 2753, 999, 462, 333, 234, 135, 27, 11, 10, 9] 출력
